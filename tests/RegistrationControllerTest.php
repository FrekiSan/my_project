...
use App\Repository\FrekiRepository;
...
class RegistrationControllerTest extends WebTestCase
{
    ...
    private FrekiRepository $userRepository;
    ...
    protected function setUp(): void
    {
        ...
        $this->userRepository = $container->get(FrekiRepository::class);
    ...
    public function testRegister(): void
    {
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'maxime.orange63@gmail.com');
        ...
        self::assertTrue(static::getContainer()->get(FrekiRepository::class)->findAll()[0]->isVerified());
    }
}
